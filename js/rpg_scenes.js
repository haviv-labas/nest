...
Scene_Map.prototype.initialize = function() {
    ...
    this._touchCount = 0;
    this.isFrameSkippingToggled = false;
};
...
Scene_Map.prototype.update = function() {
    var dummy = this.updateFrameSkippingToggled();
...
Scene_Map.prototype.updateMainMultiply = function() {
    ...
    if (this.isFrameSkippingToggled) {
        this.updateMain(); // TODO: Added for speed
        this.updateMain(); // TODO: Added for speed
        this.updateMain(); // TODO: Added for speed
    }
        
    if (this.isFastForward()) {
        this.updateMain(); // TODO: add speed
        this.updateMain(); // TODO: add speed
        this.updateMain(); // TODO: add speed
        this.updateMain(); // TODO: add speed
        this.updateMain(); // TODO: add speed
...
Scene_Map.prototype.updateFrameSkippingToggled = function() {
    if (Input.isTriggered('shift')) {
        if (this.isFrameSkippingToggled) {
            this.isFrameSkippingToggled = false
        }
        else {
            this.isFrameSkippingToggled = true
        };
        console.log("Triggered frameskipping to " + this.isFrameSkippingToggled);

    };

    return (this.isFrameSkippingToggled); 
};
